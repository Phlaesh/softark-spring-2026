...
public class HashSetLinearProbing : HashSet {
    ...
    public bool Add(Object x) {
        ...
        // skal med - ellers kan der opstå duplikater - se test!
        // pga. Set, ikke linear probing
        if (Contains(x))
        {
            return false;
        }
        ...
        // burde ikke kunne ske hvis tjek med Contains - bemærk ny kode
        // problem hvis først indsat "til venstre for" code, dernæst slettet indhold på code og indsat igen
        else if (buckets[code].Equals(x))
        {
            // pga. Set
            return false;
    ...
    public bool Remove(Object x) {
        ...
        // Tjek med Contains?
        // Ikke nødvendigt, samme kode, kan ikke indføre duplikater
